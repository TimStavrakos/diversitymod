...
##Constants
##
items_xml = ET.parse('diversitymod files/items.xml')
...
def installDiversityMod():
	...
	item_pools_xml = ET.parse('diversitymod files/itempools.xml')
	players_xml = ET.parse('diversitymod files/players.xml')
	...
	shutil.copy(currentpath + '/diversitymod files/players.xml', resourcepath + '/players.xml')
	counter = 0
	...
	splashimg = Image.open(currentpath + "/diversitymod files/splashes.png")
